...
public class HttpUtils {
	...
	public static final String[] HTTP_METHODS = {"GET", "HEAD", "POST", "PUT", "DELETE", "CONNECT", "OPTIONS", "TRACE"};
	public static final Set<String> HTTP_METHODS_SET = new HashSet<>(Arrays.asList(HTTP_METHODS));
